...
export type NodeField = {
  ...
  multiline?: boolean
  // Render as a checkbox. Value is stored as "true" / "false".
  boolean?: boolean
  required?: boolean
}
...
export const nodeRegistry = {
  ...
  act: {
    ...
    fields: [
      ...
      {
        key: "submit",
        label: "Press Enter after action",
        placeholder: "Enable when typing into search boxes or forms",
        boolean: true,
        required: false,
      },
    ],
  ...
  extract: {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder:
          "e.g. a JSON array of objects with title and url fields",
        multiline: false,
        required: false,
      },
    ],
